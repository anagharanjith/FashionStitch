...
function Footer() {
  return (
    <>
      ...
      <div className='footer-content d-flex justify-content-between'>
        <div className='media' style={{width:'400px'}}>
          <div className='d-flex align-items-center'>
            <h5 className='ps-2 fw-bolder logo'>FashionStitch</h5>
          </div>
        ...
        <div className='guides d-flex flex-column'>
          <h5>Guides</h5>
          <a href="https://react.dev/" style={{textDecoration:'none'}} target='_blank'>React JS</a>
          <a href="https://reactrouter.com/en/main" style={{textDecoration:'none'}} target='_blank'>React Routing</a>
      ...
      <p className='text-center mt-5'>Copyright &copy; 2024 FashionStitch. Built with React.</p>
    </div>
      </div>
    </>
  );
